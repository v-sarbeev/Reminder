...
public class DoneTaskAdapter extends TaskAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        TextView title = (TextView) v.findViewById(R.id.tvTaskTittle);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (item.isTask()) {
            ...
            taskViewHolder.title.setTextColor(resources.getColor(R.color.primary_text_disabled));
            taskViewHolder.date.setTextColor(resources.getColor(R.color.secondary_text_disabled));
